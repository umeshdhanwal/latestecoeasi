...
export default function ESGCompliancePlatform({
  ...
  descriptionText = "The EcoEasi Supply Chain ESG compliance platform saves huge amount of time & money while increasing the supplier response rate and level of data  analysis by combining ESG knowledge and AI.",
  ...props
}) {
  return (
    <div
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-2 sm:gap-2">
        <Heading as="h3" className="leading-[110%] sm:text-[25px]">
          {titleText}
        </Heading>
        <Text size="textmd" as="p" className="leading-[157.4%] sm:text-[18px]">
          {descriptionText}
        </Text>
      </div>
    </div>
