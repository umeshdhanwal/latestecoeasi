...
const tableData = [
  {
    ...
    manualLabelText: "Manual ",
    automatedLabelText: "Automated",
  },
  {
  ...
  },
  {
    ...
    manualLabelText: "<30-40%",
    automatedLabelText: "<90%",
  },
  {
    csrdReportText: "Annual Cost",
    manualLabelText: "<€50,000",
    automatedLabelText: "€4,000",
  },
];
...
export default function SupplyChainComplianceSection() {
  const tableColumns = React.useMemo(() => {
    ...
    return [
      tableColumnHelper.accessor("csrdReportText", {
        cell: (info) => (
          <Text as="p" className="pl-[18px]">
            {info.getValue()}
          </Text>
        ),
        header: (info) => (
          <Text as="p" className="py-3.5 pl-[18px] text-left">
            CSRD  Supplier Report for Mid-Sized Corporates (ESRS Compliant)
          </Text>
        ),
        meta: { width: "830px" },
      }),
      tableColumnHelper.accessor("manualLabelText", {
        cell: (info) => (
          <Text as="p" className="pl-[18px] text-left">
            {info.getValue()}
          </Text>
        ),
        header: (info) => (
      ...
      tableColumnHelper.accessor("automatedLabelText", {
        cell: (info) => (
          <Text as="p" className="pl-[18px] text-left">
            {info.getValue()}
          </Text>
  ...
  return (
    <>
      ...
      <div id="supplyChainCompliance"className="mt-[156px] flex flex-col items-center gap-5">
              ...
              <div className="ml-2.5 mr-[58px] md:mx-0">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-start justify-center md:flex-col">
                    <Heading size="headinglg" as="h2" className="mt-1 !text-black-900 md:text-[24px] sm:text-[22px]">
