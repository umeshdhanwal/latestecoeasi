...
const Heading = ({ children, className = "", size = "heading3xl", as, ...restProps }) => {
=======
  textmd: "text-[18px] font-medium not-italic lg:text-[15px]",
  headingxs: "text-[18px] font-bold lg:text-[15px]",
  headings: "text-[20px] font-bold lg:text-[17px]",
  ...
  headingxl: "text-[36px] font-extrabold lg:text-[30px] md:text-[34px] sm:text-[32px]",
  heading2xl: "text-[40px] font-extrabold lg:text-[34px] md:text-[38px] sm:text-[36px]",
  heading4xl: "text-[50px] font-extrabold lg:text-[42px] md:text-[46px] sm:text-[40px]",
  heading5xl: "text-[75px] font-extrabold lg:text-[75px] md:text-[48px]",
};
